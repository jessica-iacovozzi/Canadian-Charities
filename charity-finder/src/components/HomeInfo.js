    ...
    <div>
      <div id="home-info" class="custom-shape-divider-top-1679023573">
        ...
        <div className='d-flex justify-content-center align-items-center piechart'>
          <h2 className='flex-50'>Thanks to <em><a href={charityIntelligenceLink} target='_blank' rel='noreferrer'>Charity Intelligence</a></em>, it's never been easier to give with piece of mind.</h2>
